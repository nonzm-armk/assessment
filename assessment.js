...
// assessmentButton.onclick=function(){
   // function = 無名関数
   // ボタンが押されたときに関数を実行するようにする(ボタンをクリックすると'ボタンが押されました'とログが表示される)
 ...
 */
function removeAllCirdren(element){
...
assessmentButton.onclick=()=>{
  // => = アロー関数 
    ...
    if (userName.length===0){
        // 名前が空の時は処理を終了する  (名前の文字列の長さが０だった場合は、処理を終了する)
        return;
          // 戻り値なしにそこで関数の処理を終了する
    }   
        //66から70までのコード(特定の条件の時に処理を終了させる)を'ガード句'という   
    // console.log('ボタンが押されました');
    console.log(userName);
    // 診断結果表示エリアの作成
    removeAllCirdren(resultDivided)
...
const answers = [
    ...
    '{userName}のいいところは好奇心です。新しいことに向かっていく{userName}の心がまえが多くの人に魅力的に映ります。',
